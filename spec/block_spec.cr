...
describe Blockchain::Crystal::Block do
  it "reads a block header" do
    ...
    block.hash_prev_block.should eq("00000000000008a3a41b85b8b29ad444def299fee21793cd8b9e567eab02cd81".hexbytes)
    block.hash_merkle_root.should eq("2b12fcf1b09288fcaff797d71e950e71ae42b91e8bdb2304758dfcffc2b620e3".hexbytes)
  end
  ...
  it "reads all transaction data" do
    ...
    transaction.inputs[0].previous_outpoint.hash.should eq("7ae1847583b78ea9534b2da74134aa89a4d013a6b31631e71a27b9026435a8c8".hexbytes)
  ...
  it "computes hash of a transaction" do
    block = block_125552
    transaction = block.transactions[-1]
    expected = "b519286a1040da6ad83c783eb2872659eaf57b1bec088e614776ffe7dc8f6d01".hexbytes
    transaction.hash.should eq(expected)
  end

  it "computes hash of a block" do
    block = block_125552
    expected = "00000000000000001e8d6829a8a21adc5d38d0a473b144b6765798e61f98bd1d".hexbytes
